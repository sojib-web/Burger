...
class Checkout extends Component {
    ...
    submitHandler = () => {
        ...
        axios.post("https://burger-builder-b5a8a-default-rtdb.asia-southeast1.firebasedatabase.app/orders.json", order)
        .then(response =>{
      ...
      let form = (<div>
            <h4 style={{
                ...
                <form style={{
                    ...
                    <textarea name="deliveryAddress" value={this.state.values.deliveryAddress} className="form-control" 
                    placeholder="Your Address" onChange={(e) => this.inputChangerHandler(e)}></textarea>
                    <br />
                    ...
                    value={this.state.values.paymentType} onChange={(e) => this.inputChangerHandler(e)}>
